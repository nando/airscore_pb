...
function upload_track($file,$pilPk,$contact)
{
    ...
    echo BINDIR . "igcreader.pl $file $pilPk<br/>";
    exec(BINDIR . "igcreader.pl $file $pilPk", $out, $retv);

    if ($retv)
    {
        echo "<b>Failed to upload your track, it appears to have been submitted pppppppppreviously.</b><br>\n";
...
function task_score($traPk)
{
    ...
    echo BINDIR . "track_verify_sr.pl $traPk <br/>";
...
function accept_track($until, $contact, $restrict)
{
    ...
    echo "\$maxPk = upload_track(".$_FILES['userfile']['tmp_name'].", $pilPk, $comContact)";
    echo "\$maxPk -----> $maxPk";
    $tasPk = 'null';
    $tasType = '';
    $comType = '';
