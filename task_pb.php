<html>
<head>
<link HREF="xcstyle_pb.css" REL="stylesheet" TYPE="text/css">
</head>
<body>
<div id="container">
...
echo "<p><h2><a href=\"task_result_pb.php?comPk=$comPk&tasPk=$tasPk\">$comName - $tasName ($tasDate)</a></h2></p>";
...
echo "<form action=\"task_pb.php?tasPk=$tasPk\" name=\"taskadmin\" method=\"post\">";
echo "<p><table>";
...
echo "</form>";
echo "<br><hr>";
echo "<form action=\"task_result_pb.php?comPk=$comPk&tasPk=$tasPk\" name=\"taskscore\" method=\"post\">";
